...
//        let userData = NSKeyedArchiver.archivedData(withRootObject: GeneralFunctions.removeNullsFromDictionary(origin: userProfileJson as! [String : AnyObject]) )
    ...
    func saveData(){
        ...
        GeneralFunctions.saveValue(key: Utils.ENABLE_SOCKET_CLUSTER_KEY, value: userProfileJson.get("ENABLE_SOCKET_CLUSTER") as AnyObject)
        ...
        let apiKey = userProfileJson.get("GOOGLE_SERVER_IOS_PASSENGER_APP_KEY") as String
        print("CHAVE DA API: \(apiKey)")
