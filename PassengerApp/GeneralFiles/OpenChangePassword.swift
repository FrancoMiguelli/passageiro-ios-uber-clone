...
class OpenChangePassword: NSObject {
    ...
    func changePassword(currentPassword:String, password:String){
        ...
        DispatchQueue.main.async() {
            self.loadingDialog = NBMaterialLoadingDialog.showLoadingDialogWithText(self.changePasswordView, message: (GeneralFunctions()).getLanguageLabel(origValue: "Loading", key: "LBL_LOADING_TXT"))
        }
