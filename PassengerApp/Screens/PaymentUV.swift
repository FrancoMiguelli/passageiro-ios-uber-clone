...
class PaymentUV: UIViewController, MyBtnClickDelegate {
    ...
    func setData(){
        ...
        }else if(userProfileJson.get("APP_PAYMENT_METHOD") == "Xendit"){
            vStripeCusId = userProfileJson.get("vXenditToken")
        }else if userProfileJson.get("APP_PAYMENT_METHOD") == "Bepay"{
            vStripeCusId = userProfileJson.get("vBepayToken")
        }else if userProfileJson.get("APP_PAYMENT_METHOD") == "Zoop"{
            vStripeCusId = userProfileJson.get("vZoopAccountId")
        }
        ...
        if(vStripeCusId == ""){
            ...
            configCardBtn.setButtonTitle(buttonTitle: self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_CHANGE_CARD"))
        ...
        configCardBtn.setCustomColor(textColor: UIColor.UCAColor.paymentConfigBtnTextColor, bgColor: UIColor.UCAColor.AppThemeColor_Dark, pulseColor: UIColor.UCAColor.paymentConfigBtnPulseColor)
    ...
    func myBtnTapped(sender: MyButton) {
        if(sender == self.configCardBtn){
            ...
            if(userProfileJson.get("APP_PAYMENT_METHOD") == "Stripe" ||  userProfileJson.get("APP_PAYMENT_METHOD") == "Paymaya" || userProfileJson.get("APP_PAYMENT_METHOD") == "Adyen" || userProfileJson.get("APP_PAYMENT_METHOD") == "Xendit" || userProfileJson.get("APP_PAYMENT_METHOD") == "Bepay" || userProfileJson.get("APP_PAYMENT_METHOD") == "Zoop"){
    ...
    /* FOR Stripe, Paymaya, Adyen, Zoop Payment GateWay. */
    ...
    //Comentado o uso da plataforma Omise
