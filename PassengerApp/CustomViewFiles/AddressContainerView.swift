...
//        self.mainScreenUv.gMapView.animate(to: camera)
        ...
        self.mainScreenUv.gMapView.animate(with: GMSCameraUpdate.fit(bounds, with: UIEdgeInsets(top: self.mainScreenUv.addressBarYPosition + self.mainScreenUv.addressBarHeight + (self.mainScreenUv.isTripStarted ? self.mainScreenUv.heightOfWaitingMarker : 0), left: 0, bottom: 0, right: 0)))
        CATransaction.commit()
