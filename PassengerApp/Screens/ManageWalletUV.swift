...
//        headerView.layer.shadowRadius = 1.1
        ...
        self.addMoneyHLbl.text = self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_ADD_MONEY_TXT").uppercased()
        ...
        addMoneyBtn.setButtonTitle(buttonTitle: self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_ADD_MONEY_TXT"))
        ...
        viewTransactionBtn.setCustomColor(textColor: UIColor.UCAColor.walletPageViewTransBtnTextColor, bgColor: UIColor.UCAColor.AppThemeColor_Dark, pulseColor: UIColor.UCAColor.walletPageViewTransBtnPulseColor)
