    ...
    func checkData(){
        ...
        let cpfEntered = Utils.checkText(textField: self.cpfTxtField.getTextField()!) ?
            (self.cpfTxtField.text.isValidCPF ? true: Utils.setErrorFields(textField:
                self.cpfTxtField.getTextField()!, error: "CPF Inválido")) : Utils.setErrorFields(textField: self.cpfTxtField.getTextField()!, error: required_str)
