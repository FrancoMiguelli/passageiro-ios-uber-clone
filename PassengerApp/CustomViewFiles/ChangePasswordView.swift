...
class ChangePasswordView: UIView, MyLabelClickDelegate {
    ...
    func xibSetup() {
        ...
        currentPassTxtField.fontFamilyName = "Roboto-Bold"
        currentPassTxtField.fontSize = 16
        newPassTxtField.fontFamilyName = "Roboto-Bold"
        newPassTxtField.fontSize = 16
        reEnterNewPassTxtField.fontFamilyName = "Roboto-Bold"
        reEnterNewPassTxtField.fontSize = 16
    }
