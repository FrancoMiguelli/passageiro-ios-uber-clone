...
class MyLabel: UILabel {
    ...
    func setFontFamily(){
        if(fontFamilyName == nil){
            fontFamilyName = "Roboto-Bold"
        }
        self.font = RobotoFont.bold(with: self.font.pointSize)//UIFont(name: fontFamilyName!, size: self.font.pointSize)
    }
...
//        super.drawText(in: frame.inset(by: UIEdgeInsets(top: padding.top, left: padding.left, bottom: padding.bottom, right: padding.right)))
//    }
