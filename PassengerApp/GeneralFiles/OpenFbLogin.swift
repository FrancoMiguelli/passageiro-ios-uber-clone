...
class OpenFbLogin: NSObject, FBSDKLoginButtonDelegate, UIWebViewDelegate {
    ...
    func openLoader(){
        DispatchQueue.main.async() {
            self.loadingDialog = NBMaterialLoadingDialog.showLoadingDialogWithText(self.uv.view, message: (GeneralFunctions()).getLanguageLabel(origValue: "Loading", key: "LBL_LOADING_TXT"))
        }
    }
