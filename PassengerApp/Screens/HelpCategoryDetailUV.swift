...
//        self.navigationItem.title = self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_HELP_TXT")
    ...
    func setData(){
        ...
        let categoryNameHeight = categoryNameLbl.text!.height(withConstrainedWidth: Application.screenSize.width - 32, font: UIFont(name: "Roboto-Medium", size: 18)!)
        ...
        self.btnSubmit.isAppTheme = true
    ...
    @objc func selectCategoryTapped(){
        ...
        openListView.show(listObjects: allSubCategoriesNameArr, title: self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_SELECT_RES_TO_CONTACT"), currentInst: openListView, handler: { (selectedItemId) in
