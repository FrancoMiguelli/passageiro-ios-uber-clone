...
//  PassengerApp
//
//  Created by Marlon da Rocha on 22/01/2019.
...
public struct JosefinFont: FontType {
    ...
    public static func regular(with size: CGFloat) -> UIFont {
        Font.loadFontIfNeeded(name: "JosefinSans-Regular")
        
        if let f = UIFont(name: "JosefinSans-Regular", size: size) {
            return f
        }
    ...
    public static func medium(with size: CGFloat) -> UIFont {
        Font.loadFontIfNeeded(name: "JosefinSans-Medium")
        
        if let f = UIFont(name: "JosefinSans-Medium", size: size) {
            return f
        }
